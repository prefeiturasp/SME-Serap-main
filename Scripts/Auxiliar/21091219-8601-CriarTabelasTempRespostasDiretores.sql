CREATE INDEX QuestionarioUsuario_Edicao_IDX ON QuestionarioUsuario(Edicao);
--drop index QuestionarioUsuario.QuestionarioUsuario_Edicao_IDX
CREATE NONCLUSTERED INDEX [QuestionarioUsuario_QuestionarioID_IDX] ON [dbo].[QuestionarioUsuario]([QuestionarioID] )
CREATE NONCLUSTERED INDEX [QuestionarioRespostaItem_QuestionarioUsuarioID_IDX] ON [dbo].[QuestionarioRespostaItem]([QuestionarioUsuarioID])
...
-------------
--DIRETORES
DROP TABLE Questionarios24_2019
SELECT piv.* INTO Questionarios24_2019
	FROM (
...
ALTER TABLE Questionarios24_2019
ADD CONSTRAINT Questionarios24_2019_QuestionarioUsuarioID_FK FOREIGN KEY (QuestionarioUsuarioID) 
REFERENCES QuestionarioUsuario(QuestionarioUsuarioID)

CREATE INDEX Questionarios24_2019_QuestionarioUsuarioID_IDX ON Questionarios24_2019(QuestionarioUsuarioID);
...
FROM QuestionarioUsuario qu
	...
	INNER JOIN Questionarios24_2019 rc 

...
PRINT N'Altering [dbo].[AbsenceReason]...';
GO

ALTER TABLE [dbo].[AbsenceReason] ADD [IsDefault] BIT  DEFAULT ((0)) NOT NULL;
GO


PRINT N'Altering [dbo].[AnswerSheetBatchFiles]...';
ALTER TABLE [dbo].[AnswerSheetBatchFiles] ADD [CreatedBy_Id] [uniqueidentifier]
GO
...
DECLARE @ent_id UNIQUEIDENTIFIER = (SELECT TOP 1 [EntityId] FROM [dbo].[AbsenceReason])

INSERT INTO [dbo].[AbsenceReason] ([Description], [CreateDate], [UpdateDate], [AllowRetry], [State], [EntityId], [IsDefault]) 
VALUES (N'Ausente correção', GETDATE(), GETDATE(), 0, 1, @ent_id, 1)
...
BEGIN
	...
	FROM    (
			 ...
			 SELECT t.Id AS TestId,
					...
					t.[Global],
					t.ItemType_Id,
					CONVERT(VARCHAR(50), t.CreateDate, 103) + ' ' + CONVERT(VARCHAR(12), t.CreateDate, 108) AS CreateDate,					
					CONVERT(VARCHAR(50), t.UpdateDate, 103) + ' ' + CONVERT(VARCHAR(12), t.UpdateDate, 108) AS UpdateDate,

...
namespace GestaoAvaliacao.IBusiness
{
    public interface IReportItemPerformanceBusiness
    {
        ...
        PerformanceItemViewModel GetPerformanceTree(long test_id, long subGroup_id, long tcp_id, SYS_Usuario usuario, SYS_Grupo grupo, Guid? dre_id, int? esc_id, Guid? uad_id, bool? export = false);
    }
}

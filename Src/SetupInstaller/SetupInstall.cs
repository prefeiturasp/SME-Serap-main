using GestaoAvaliacao.WebSocketService;
using System;
...
namespace SetupInstaller
{
	public partial class SetupInstall : Form
	{
		...
		private void CopiarArquivos(string caminhoInstalacao)
		{
			...
			string[] extensions = new string[] { ".dll", ".exe", ".config", ".xml" };
		...
		private void InstalarServico(string nomeServico, string caminhoInstalacao)
		{
			...
			WebSocketInstaller installer = new WebSocketInstaller();
		...
		private void btnValidarConfig_Click(object sender, EventArgs e)
		{
			ReadWebConfig form = new ReadWebConfig();
			form.Show();
		}

		private void btnValidarConexao_Click(object sender, EventArgs e)
		{

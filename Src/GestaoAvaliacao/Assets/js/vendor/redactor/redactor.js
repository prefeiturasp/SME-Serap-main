	...
	Redactor.fn = $.Redactor.prototype = {
		...
		button: function()
		{
			return {
				...
				{
					var $button = $('<a href="javascript:void(0)" class="re-icon re-' + btnName + '" rel="' + btnName + '" />').attr({'role': 'button', 'aria-label': btnObject.title, 'tabindex': '-1'});
		...
		dropdown: function()
		{
			return {
				build: function(name, $dropdown, dropdownObject)
				{
					...
					{
						var $item = $('<a href="javascript:void(0)" class="redactor-dropdown-' + btnName + '" role="button">' + btnObject.title + '</a>');
		...
		modal: function()
		{
			return {
				...
				{
					var $tab = $('<a href="javascript:void(0)" rel="tab' + id + '">').text(name);
					if (active)
					{
						$tab.addClass('active');
					}
		...
		observe: function()
		{
			return {
				...
				showTooltip: function(e)
				{
					...
					var aEdit = $('<a href="javascript:void(0)" />').html(this.lang.get('edit')).on('click', $.proxy(this.link.show, this)).addClass('redactor-link-tooltip-action');
					var aUnlink = $('<a href="javascript:void(0)" />').html(this.lang.get('unlink')).on('click', $.proxy(this.link.unlink, this)).addClass('redactor-link-tooltip-action');
		...
		upload: function()
		{
			return {
				...
				traverseFile: function(file, e)
				{
					...
					this.upload.sendData(file, formData, e);
				},

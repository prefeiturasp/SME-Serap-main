...
angular.module('tooltip', ['helpers.dimensions'])
  ...
  .provider('$tooltip', function () {
      ...
      var defaults = this.defaults = {
          ...
          target: false,
          placement: 'top',
          template: base_url('Assets/js/angular/directives/_bundle/popover/tooltip.html'),
      ...
      this.$get = ['$window', '$rootScope', '$compile', '$q', '$templateCache', '$http', '$animate', 'dimensions', '$$rAF', '$timeout', function ($window, $rootScope, $compile, $q, $templateCache, $http, $animate, dimensions, $$rAF, $timeout) {
          ...
          function TooltipFactory(element, config) {
              ...
              $tooltip.hide = function (blur) {
                  ...
                  if (scope.timeraction != undefined) {
                      $timeout.cancel(scope.timeraction);
                      scope.timeraction = undefined;
                  }

                  scope.timeraction = $timeout(
                      function () {
          ...
          function fetchTemplate(template) {
              ...
              $http({ method: 'GET', url: template, cache: $templateCache })

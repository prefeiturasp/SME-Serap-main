...
{
    [CollectionName("CorrectionResults")]
	public class CorrectionResults : EntityBase
	{
        ...
        public CorrectionResults()
		{

		}

        public CorrectionResults(Guid ent_id, long test_id, long tur_id)
        {
        ...
        public CorrectionResults(Guid ent_id, long test_id, long tur_id, Guid dre_id, int esc_id, int cur_id, int crr_id, int crp_id)
		{

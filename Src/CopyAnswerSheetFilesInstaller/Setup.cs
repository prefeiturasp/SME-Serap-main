...
namespace CopyAnswerSheetFilesInstaller
{
	public partial class Setup : Form
	{
		...
		private void InstalarServico(string nomeServico, string caminhoInstalacao)
		{
            ...
            GestaoAvaliacao.CopyAnswerSheetFilesService.CopyAnswerSheetFilesInstaller installer = new GestaoAvaliacao.CopyAnswerSheetFilesService.CopyAnswerSheetFilesInstaller();

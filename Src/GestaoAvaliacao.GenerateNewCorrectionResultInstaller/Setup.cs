...
namespace GestaoAvaliacao.GenerateNewCorrectionResultInstaller
{
    public partial class Setup : Form
	{
		...
		private void InstalarServico(string nomeServico, string caminhoInstalacao)
		{
            ...
            GenerateNewCorrectionResultService.GenerateNewCorrectionResultInstaller installer = new GenerateNewCorrectionResultService.GenerateNewCorrectionResultInstaller();

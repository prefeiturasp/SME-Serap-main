...
{
    public class AdminItemProvaBusiness : IAdminItemProvaBusiness
    {
        ...
        public AdminItemProvaBusiness()
        {
            this.baseUrl = BuscarConfiguracaoObrigatoria("URL_ADMIN_ITEM_PROVA");

...
{
    partial class AnswerSheetLotInstaller
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			this.SvcInstallerServerScheduler.Description = "AvaliaMais AnswerSheetLot ";
			this.SvcInstallerServerScheduler.DisplayName = "AvaliaMais AnswerSheetLot ";
			this.SvcInstallerServerScheduler.ServiceName = "AvaliaMais AnswerSheetLot";

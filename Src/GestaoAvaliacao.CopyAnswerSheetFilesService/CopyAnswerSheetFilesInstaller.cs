...
{
	[RunInstaller(true)]
	public partial class CopyAnswerSheetFilesInstaller : System.Configuration.Install.Installer
	{
		public CopyAnswerSheetFilesInstaller()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterInstall(IDictionary savedState)
		{
			try
			{
				...
				appLog.Source = "GestaoAvaliacao_CopyAnswerSheetFiles";

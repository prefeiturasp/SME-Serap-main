...
{
	partial class CopyAnswerSheetFilesInstaller
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			this.SvcInstallerServerScheduler.Description = "AvaliaMais CopyAnswerSheetFiles";
			this.SvcInstallerServerScheduler.DisplayName = "AvaliaMais CopyAnswerSheetFiles";
			this.SvcInstallerServerScheduler.ServiceName = "AvaliaMais CopyAnswerSheetFiles";

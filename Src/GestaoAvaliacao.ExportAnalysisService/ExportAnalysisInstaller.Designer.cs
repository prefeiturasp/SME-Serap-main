...
{
    partial class ExportAnalysisInstaller
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			this.SvcInstallerServerScheduler.Description = "AvaliaMais ExportAnalysis";
			this.SvcInstallerServerScheduler.DisplayName = "AvaliaMais ExportAnalysis";
			this.SvcInstallerServerScheduler.ServiceName = "AvaliaMais ExportAnalysis";

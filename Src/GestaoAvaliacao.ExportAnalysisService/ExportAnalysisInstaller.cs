...
{
    [RunInstaller(true)]
	public partial class ExportAnalysisInstaller : System.Configuration.Install.Installer
	{
		public ExportAnalysisInstaller()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterInstall(IDictionary savedState)
		{
			try
			{
				...
				appLog.Source = "GestaoAvaliacao_ExportAnalysis";

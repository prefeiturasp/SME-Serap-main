...
{
    [RunInstaller(true)]
	public partial class CorrectionResultInstaller : System.Configuration.Install.Installer
	{
		public CorrectionResultInstaller()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterInstall(IDictionary savedState)
		{
			try
			{
				...
				appLog.Source = "GestaoAvaliacao_CorrectionResult";

...
namespace GestaoAvaliacao.Util.QRCode
{
    public class QRCode : AbstractQRCode<Bitmap>
    {
        ...
        public Bitmap GetGraphic(int pixelsPerModule, Color darkColor, Color lightColor, Bitmap icon, int iconSizePercent, int iconBorderWidth)
        {
            var size = qrCodeData.ModuleMatrix.Count * pixelsPerModule;
        ...
        public static Bitmap RenderQRCode(string text, int pixelsPerModule)
        {
            ...
            Bitmap bmp = qrCode.GetGraphic(pixelsPerModule, Color.Black, Color.White);

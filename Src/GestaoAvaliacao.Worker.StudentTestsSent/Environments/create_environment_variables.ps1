...
[Environment]::SetEnvironmentVariable("GestaoAvaliacaoWorkerMongoDSettings__ConnectionString", "mongodb://localhost:27017/GestaoAvaliacao_OMR", "Machine")
[Environment]::SetEnvironmentVariable("GestaoAvaliacaoWorkerMongoDSettings__Database", "GestaoAvaliacao_OMR", "Machine")

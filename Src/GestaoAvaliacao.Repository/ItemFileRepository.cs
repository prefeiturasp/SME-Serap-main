...
namespace GestaoAvaliacao.Repository
{
    public class ItemFileRepository : ConnectionReadOnly, IItemFileRepository
    {
        ...
        {
            var sql = @"SELECT IFI.Id AS ItemFileId, IFI.Item_Id, F.Id AS FileId, F.[Path], F.Name, FT.Id AS ThumbnailId, FT.[Path] AS ThumbnailPath,
                        FT.Name AS ThumbnailName, FC.Id AS ConvertedFileId, FC.Name AS ConvertedFileName, FC.[Path] AS ConvertedFilePath

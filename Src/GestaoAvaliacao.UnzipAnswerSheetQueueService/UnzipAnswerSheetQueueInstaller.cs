...
{
    [RunInstaller(true)]
	public partial class UnzipAnswerSheetQueueInstaller : System.Configuration.Install.Installer
	{
		public UnzipAnswerSheetQueueInstaller()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterInstall(IDictionary savedState)
		{
			try
			{
				...
				appLog.Source = "GestaoAvaliacao_UnzipAnswerSheetQueue";

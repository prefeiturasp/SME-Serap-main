...
namespace GestaoAvaliacao.AnswerSheetLotInstaller
{
    public partial class Setup : Form
	{
		...
		private void InstalarServico(string nomeServico, string caminhoInstalacao)
		{
			...
			AnswerSheetLotService.AnswerSheetLotInstaller installer = new AnswerSheetLotService.AnswerSheetLotInstaller();
		...
		{
			return String.Format("Versão: {0}", Application.ProductVersion);
		}
